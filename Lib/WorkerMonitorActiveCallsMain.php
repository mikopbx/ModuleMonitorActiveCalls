...
class WorkerMonitorActiveCallsMain extends WorkerBase
{
    protected MonitorActiveCallsMain $templateMain;
    ...
    {
        $this->templateMain = new MonitorActiveCallsMain();
...
$workerClassname = WorkerMonitorActiveCallsMain::class;
