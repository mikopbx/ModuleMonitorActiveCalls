...
class LegacyAsteriskManager
{
     ...
     *
     * @param $actionid message matching variable
     *
     * @return array
     */
     ...
     * @return array
     */
    public function Status(string $channel, $actionid = null): array
    {
        $parameters = ['Channel' => $channel];
        if ($actionid) {
            $parameters['ActionID'] = $actionid;
    ...
    */
     ...
     * @return bool sucess
     */
    public function addEventHandler(string $event, $callback): bool
    {
